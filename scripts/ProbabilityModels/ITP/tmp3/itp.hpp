...
stan::io::program_reader prog_reader__() {
    ...
    reader.add_event(0, 0, "start", "/Users/rob/.julia/dev/DynamicHMCModels/scripts/ProbabilityModels/ITP/tmp/itp.stan");
    reader.add_event(106, 104, "end", "/Users/rob/.julia/dev/DynamicHMCModels/scripts/ProbabilityModels/ITP/tmp/itp.stan");
    return reader;
}

class itp_model : public prob_grad {
private:
        int N1;
        int N2;
        int T;
        ...
        matrix_d domain_map;
public:
    itp_model(stan::io::var_context& context__,
    ...
    void ctor_body(stan::io::var_context& context__,
        ...
        static const char* function__ = "itp_model_namespace::itp_model";
    ...
    void write_array(RNG& base_rng__,
        ...
        vars__.resize(0);
        stan::io::reader<local_scalar_t__> in__(params_r__, params_i__);
        static const char* function__ = "itp_model_namespace::write_array";
        (void) function__;  // dummy to suppress unused var warning
...
typedef itp_model_namespace::itp_model stan_model;
